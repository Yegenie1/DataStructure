...
public class 배열과컬렉션변환3 {
	...
	public static void main(String[] args) {
		...
		// 새로 만들어주면 됨.
		ArrayList<String> list = new ArrayList<String>(Arrays.asList(s2));//배열의 내용으로 arraylist를 만들어 넣어라
		ArrayList<String> list2 = new ArrayList<String>();//내용없는 arraylist를 만들어라
